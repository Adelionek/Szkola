...
//var regImie = /^[a-zążźćóńęł]{2,32}$/i;
var regImie = /^[A-Z]{1}[a-zążźćęńół]{1,31}$/; //regex do sprawdzania imienia, usuneliśmy funkcje sprawdz i robimy to łatwiej
var regNazwisko = /^[A-Z]{1}[a-zążźćóńęł]{1,31}[A-Z]{1}(\-[a-zążźćóńęł]{1,31})?$/i;//regex do nazwiska jest podobny do imienia tylko dotajemy \- zeby mozna bylo uzyc myslnika.
...
///zamien imie i nazwisko ak aby pierwsze litery  byly duze w nazwisku tez te po myslniku. data musi byc mniejsza od tay dzisiejszej
